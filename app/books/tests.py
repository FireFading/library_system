...
from books.views import SearchResultsView, add_book, catalog, home, new_book
...
class BookTest(TestCase):
    def setUp(self):
        self.client = Client()
        self.user = User.objects.create_user(username="testuser", email="test@email.com", password="secret")
        self.book = Book.objects.create(title="testbook", author="testuser", year=2015, number=3)
    ...
    def test_add_book(self):
        ...
        self.client.post(
            reverse("new_book"),
            {
                "adding_title": "testing",
                "adding_author": "testauthor",
                "year": "2015",
                "number": "2",
            },
        )
